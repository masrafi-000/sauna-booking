    ...
    <div class="sb-popup sb-popup-booking">
        ...
        <form id="sbBookingForm" class="sb-booking-form" novalidate>
            ...
            <div class="sb-stripe-wrap">
                <label class="sb-stripe-label" for="sbCardElement">Card Information</label>
                <div id="sbCardElement" class="sb-card-element"></div>
                <div id="sbCardErrors" class="sb-card-errors" role="alert"></div>
            </div>
            <div class="sb-amount-total" id="sbAmountTotal"></div>
